...
Script Purpose:
    ...
    It performs the following actions:
      ...
      - Uses the 'BULK INSERT' command to load data from csv Files to bronze tablöes.
Parameters:
  None.
...
/* docker cp /Users/hadis/Desktop/sql-data-warehouse-project/datasets sqlserver:/tmp/datasets
*/
-- CRM data
...
BEGIN
    ...
    BEGIN TRY
        ...
        PRINT'==================================================='
        PRINT 'Losding Bronze Layer is Completed!'

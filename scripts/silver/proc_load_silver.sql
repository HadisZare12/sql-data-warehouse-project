...
BEGIN
    ...
    BEGIN TRY
        ...
        SET @start_time = GETDATE();
        PRINT'>>Truncating table:silver.erp_cust_a101 ';
        TRUNCATE TABLE silver.erp_cust_a101;
        PRINT '>>Inserting table:silver.erp_cust_a101';
        INSERT INTO silver.erp_cust_a101(
            cid,
            cntry
        )
        SELECT 
